...
/**
 * Class GetPlayersWeb is a dialog used to enter players' 
 * names, types, variant, etc. in the case the game is started
 * on a players PC based on information from the "Web Server".
 *  
 * I deliberately copied the original GetPlayers, because this
 * here might need quite some changes, and I want to make some
 * experiments, and not to risk breaking the main start point
 * how to start normal games.
 * When this here has stabilized, perhaps they can be merged
 * again...
 * 
 * @version $Id: GetPlayersWeb.java 3749 2009-03-10 17:21:21Z cleka $
 * @author David Ripton
 * @author Romain Dolbeau
 * @author Clemens Katzer
 */
@SuppressWarnings("serial")
public final class GetPlayersWeb extends KFrame implements WindowListener,
    ActionListener, ItemListener
{
    ...
    public GetPlayersWeb(Options options, Object mutex, Start startObject)
    {
        super("Game Setup");
