 ...
 *
 * SimpleAI:
 * @author Bruce Sherrod, David Ripton, Romain Dolbeau (SimpleAI)
 * @author Clemens Katzer (cloned SimpleAI to do own experiments)
 */
public class ClemensAI extends AbstractAI
{
    private static final Logger LOGGER = Logger.getLogger(ClemensAI.class
        .getName());
        ...
        MasterBoardTerrain terrain)
    {
        if (creature.isTitan())
        {
            ...
            LOGGER.warning("Called ClemensAI.getCombatValue() for Titan");
