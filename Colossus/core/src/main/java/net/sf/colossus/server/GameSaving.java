...
public class GameSaving
{
    ...
    /**
     * For AI development - remember last autosaved file, so that we can provide
     * it as "situation xxx happened, last autosave before that was ...."
     */
    public static String lastSaveGame;
    ...
    /**
     * For AI development/debugging
     * @return Name of last autosave file
     */
    public static String getLastSaveGame()
    {
        return lastSaveGame;
    }
