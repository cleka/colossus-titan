 ...
 * @version $Id: BattlelandRandomizerLoader.jj 3655 2009-02-27 09:41:32Z dolbeau $
...
public class BattlelandRandomizerLoader implements BattlelandRandomizerLoaderConstants {
  ...
  final public address z_address() throws ParseException {
    ...
    if (jj_2_7(20)) {
      ...
      jj_consume_token(CLOSEPAR);
        {if (true) return new address(x,y);}
    } else if (jj_2_8(20)) {
      jj_consume_token(CASELABEL);
        ...
        case 'f':
            ...
            break;
        default:
            {if (true) throw new ParseException("Hex " + token.image + "doesn't exist");}
        }
  ...
  final public hazardPair z_hazardPair() throws ParseException {
    ...
    ed = z_number();
    jj_consume_token(CLOSEPAR);
        {if (true) return new hazardPair(ts,es,td,ed);}
    throw new Error("Missing return statement in function");
  }
  ...
  private boolean jj_3_6() {
    if (jj_scan_token(QUOTEDCHAINE)) return true;
    return false;
  }

  private boolean jj_3_27() {
    if (jj_scan_token(KEYLABEL)) return true;
  ...
  private boolean jj_3_10() {
    if (jj_scan_token(SUBSTRACT)) return true;
    if (jj_scan_token(OPENPAR)) return true;
    if (jj_3R_2()) return true;
    if (jj_scan_token(COMMA)) return true;
    if (jj_3R_2()) return true;
  ...
  private boolean jj_3R_9() {
    if (jj_scan_token(HAZARD)) return true;
    return false;
  }
  ...
  private boolean jj_3_13() {
    if (jj_scan_token(OPENPAR)) return true;
    if (jj_scan_token(USEDUP)) return true;
    if (jj_scan_token(CLOSEPAR)) return true;
    if (jj_3R_2()) return true;
    return false;
  }
  ...
  private boolean jj_3_8() {
    if (jj_scan_token(CASELABEL)) return true;
    return false;
  }
  ...
  public BattlelandRandomizerLoader(java.io.InputStream stream, String encoding) {
    try { jj_input_stream = new SimpleCharStream(stream, encoding, 1, 1); } catch(java.io.UnsupportedEncodingException e) { throw new RuntimeException(e); }
    token_source = new BattlelandRandomizerLoaderTokenManager(jj_input_stream);
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
