...
This file describe the variant. It's a pure text file. It must be named README and live in the same directory as the \texttt{VAR} file (see below, section \ref{VAR}). It's displayed in the opening dialog.
