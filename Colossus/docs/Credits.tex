...
\item[Programming] David Ripton [\htmladdnormallink{dripton@wizard.net}{mailto:dripton@wizard.net}], Bruce Sherrod (AI), Romain Dolbeau (variant support, overlay display), Tom Fruchterman (caretaker display), Peter Becker, David Barr (applet conversion)
