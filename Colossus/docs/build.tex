...
Among the nice editors for Unix, there's \hypercite{XEmacs}{XEmacs}{}{XEMACS}. XEmacs can use the \hypercite{Java Development Environment for Emacs}{Java Development Environment for Emacs}{}{JDE}.
