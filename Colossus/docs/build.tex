...
See \hypercite{Sun JDK}{}{}{SUNJDK}. I think that the Sun \texttt{JDK} is currently
...
See \hypercite{Blackdown JDK}{}{}{BLACKDOWNJDK}.
...
a \texttt{JDK} is \htmladdnormallink{http://java.sun.com/cgi-bin/java-ports.cgi}{http://java.sun.com/cgi-bin/java-ports.cgi}
...
\hypercite{Jikes}{Jikes}{}{JIKES} is Open Source very fast Java compiler written
in C++, originally
...
There are two main alternatives for building Colossus, \hypercite{ant}{ant}{}{ANT} and make.
...
Colossus uses the \hypercite{JavaCC}{JavaCC}{}{JAVACC} parser generator written by Sun and Matamata.  
...
Direct access to the archive file: \htmladdnormallink{http://www.webgain.com/trialware/javacc/JavaCC2\_1.zip}{http://www.webgain.com/trialware/javacc/JavaCC2\_1.zip}
...
We use \hypercite{\texttt{CVS}}{\texttt{CVS}}{}{CVS}, with the repository hosted on \hypercite{SourceForge}{SourceForge}{}{SOURCEFORGE}.
\texttt{SF} requires \hypercite{ssh}{ssh}{}{SSH} or
\hypercite{OpenSSH}{OpenSSH}{}{OPENSSH}  instead of the insecure pserver as a transport mechanism,
...
\htmladdnormallink{http://java.sun.com/products/javawebstart/}{http://java.sun.com/products/javawebstart/}. You want javaws in your
\texttt{PATH}.

(An alternate \texttt{JNLP} launcher, in case there is no \texttt{JWS} for your platform,
is Open\texttt{JNLP} at \htmladdnormallink{http://openjnlp.nanode.org}{http://openjnlp.nanode.org}. I haven't
...
\htmladdnormallink{http://colossus.sf.net/downloads}{http://colossus.sf.net/downloads}, or (to get
