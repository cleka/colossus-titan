...
\hypercite{Jikes}{Jikes}{}{JIKES} is a very fast Open Source Java compiler
...
\htmladdnormallink{http://www.experimentalstuff.com/Technologies/JavaMake/
...
If you're using Windows see \hypercite{PuTTY}{}{}{PUTTY} for a good free 
SSH/Telnet client. General SourceForge documentation is at 
\htmladdnormallink{http://sourceforge.net/docman/?group\_id=1}{http://sourceforge.net/docman/?group\_id=1}.
...
Two popular free portable editors are \hypercite{Vim}{Vim}{}{Vim} and 
\hypercite{XEmacs}{XEmacs}{}{XEMACS}. XEmacs can use the
...
Jacobe (http://www.tiobe.com/jacobe.htm) is free (but not open
source) and works pretty well.  It's available for Windows and Linux.
The only important feature it lacks is line length control.  There is 
a Jacobe cfg file in the buildtools directory.

There are other options, but I haven't found another good free one.
...
We've added a few unit tests using \hypercite{JUnit}{JUnit}{}{JUNIT}.  
We need to add more.
