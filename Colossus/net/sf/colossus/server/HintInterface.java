...
public interface HintInterface
{
     ...
     * @param recruits List of all recruitable Creature (returned value must be the name of one of those)
     * @param oracle An oracle that answers some questions about the situation of the legion
    ...
    public List getInitialSplitHint(String label,
                                    String[] section);
    /**
     * Give an offset to apply to the creature Point Value before estimating it's recruitment value.
