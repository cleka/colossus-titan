...
/**
 * Class BasicGUIBattleHex holds GUI info for one battle hex.
 * @version $Id$
 * @author David Ripton
 */

public class BasicGUIBattleHex extends BattleHex
{
    ...
    public BasicGUIBattleHex(int cx, int cy, int scale, int xCoord, int yCoord)
    {
        super(xCoord, yCoord);
