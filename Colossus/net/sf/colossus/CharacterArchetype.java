 ...
 * <P><B>TODO:</B>rename to CreatureConstants, which would be a better name
 *
 *  @version $Id$
...
public class CharacterArchetype
{
	...
	/** We are borrowing this new object to help re-implemnent the old Caretaker object
	 * in the main code. So this isn't the real caretakers stack, we are just 
	 * borrowing it because it has the maximum character counts
	 */
	private static CreatureKeeperData s_oCreatureKeeperData = new CreatureKeeperData();
	static
		{
			// Initialize the counts. Since we never change them
			// they will always be the maximum
