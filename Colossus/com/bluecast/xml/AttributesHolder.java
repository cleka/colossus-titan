 ...
 * @version $Revision$
 */
final public class AttributesHolder
    ...
    public void addAndCheckAttribute (String uri, String localName, String qName,
        ...
        // Check the QName for duplicates
        for (int i = 0; i < length; i++) {
            if (data[i*5 + 2] == qName)
                throw  new SAXException("duplicate attribute '" + qName + "'");
        }
     ...
     *            in the list.
     */
    public void setAttribute (int index, String uri, String localName, String qName,
